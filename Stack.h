...
public:
  ...
  /// Shrinks the stack to get rid of unused data.
  void shrink (void);
...
private:
  // add member variable here
    ...
    // RESPONSE Changed so that data_ is on the stack. Updated code to reflect this
    
  /// Array that holds the data of type T for the stack
  Array <T> data_;
};
