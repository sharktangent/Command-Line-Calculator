 ...
 * @class Array_Base
 * 
 * A basic Array with limited functionality.
 */
template <typename T>
class Array_Base
{
public:
	 ...
	 * occurrence of the element is returned. If the character is not
	...
	/**
	 * The slice() method returns as shallow copy of a portion of an array into
